 ...
 */
 ...
 ( function() {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		scrollButton.setAttribute( 'aria-label', merciaProScrollToTop.label );
		scrollButton.classList.add( 'scroll-to-top-button' );

		// Add icon to Scroll to Top button.
		var icon = new DOMParser().parseFromString( merciaProScrollToTop.icon, 'text/html' ).body.firstElementChild;

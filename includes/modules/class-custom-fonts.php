...
class Mercia_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		require_once MERCIA_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-control.php';

		// Add Custom Fonts CSS code to custom stylesheet output.
		add_filter( 'mercia_pro_custom_css_stylesheet', array( __CLASS__, 'get_custom_fonts_css' ) );

		// Load Custom Fonts with the built-in theme functions.
		add_filter( 'mercia_get_fonts_url', array( __CLASS__, 'get_custom_fonts_url' ) );
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_control( new Mercia_Pro_Customize_Font_Control(
			$wp_customize, 'text_font', array(
				'label'    => esc_html__( 'Body Font', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_typography',
		...
		$wp_customize->add_setting( 'mercia_theme_options[title_is_bold]', array(
		...
		$wp_customize->add_control( 'mercia_theme_options[title_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'mercia-pro' ),
			'section'  => 'mercia_pro_section_typography',
			'settings' => 'mercia_theme_options[title_is_bold]',
			'type'     => 'checkbox',
			'priority' => 30,
		) );

		// Add Title Uppercase setting.
		$wp_customize->add_setting( 'mercia_theme_options[title_is_uppercase]', array(
		...
		$wp_customize->add_control( 'mercia_theme_options[title_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'mercia-pro' ),
			'section'  => 'mercia_pro_section_typography',
			'settings' => 'mercia_theme_options[title_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 40,
		) );
		...
		$wp_customize->add_setting( 'mercia_theme_options[navi_is_bold]', array(
		...
		$wp_customize->add_control( 'mercia_theme_options[navi_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'mercia-pro' ),
			'section'  => 'mercia_pro_section_typography',
			'settings' => 'mercia_theme_options[navi_is_bold]',
			'type'     => 'checkbox',
			'priority' => 60,
		) );

		// Add Navi Uppercase setting.
		$wp_customize->add_setting( 'mercia_theme_options[navi_is_uppercase]', array(
		...
		$wp_customize->add_control( 'mercia_theme_options[navi_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'mercia-pro' ),
			'section'  => 'mercia_pro_section_typography',
			'settings' => 'mercia_theme_options[navi_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 70,
		) );
		...
		$wp_customize->add_setting( 'mercia_theme_options[widget_title_is_bold]', array(
		...
		$wp_customize->add_control( 'mercia_theme_options[widget_title_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'mercia-pro' ),
			'section'  => 'mercia_pro_section_typography',
			'settings' => 'mercia_theme_options[widget_title_is_bold]',
			'type'     => 'checkbox',
			'priority' => 90,
		) );

		// Add Widget Title Uppercase setting.
		$wp_customize->add_setting( 'mercia_theme_options[widget_title_is_uppercase]', array(
		...
		$wp_customize->add_control( 'mercia_theme_options[widget_title_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'mercia-pro' ),
			'section'  => 'mercia_pro_section_typography',
			'settings' => 'mercia_theme_options[widget_title_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 100,
		) );
	}
...
// Run Class.
add_action( 'init', array( 'Mercia_Pro_Custom_Fonts', 'setup' ) );

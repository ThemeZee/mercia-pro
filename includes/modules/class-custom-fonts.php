...
class Mercia_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		require_once MERCIA_PRO_PLUGIN_DIR . 'includes/customizer/class-font-list.php';
		require_once MERCIA_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-control.php';
		require_once MERCIA_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-list-control.php';

		// Add Custom Color CSS code to custom stylesheet output.
		add_filter( 'mercia_pro_custom_css_stylesheet', array( __CLASS__, 'custom_fonts_css' ) );

		// Load custom fonts from Google web font API.
		add_filter( 'mercia_google_fonts_url', array( __CLASS__, 'google_fonts_url' ) );
	 ...
	 *
	 * @uses mercia_google_fonts_url filter hook
	...
	static function google_fonts_url( $google_fonts_url ) {
		...
		$default_fonts = Mercia_Pro_Custom_Font_Lists::default_browser_fonts();

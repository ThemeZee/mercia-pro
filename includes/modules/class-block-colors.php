...
class Mercia_Pro_Block_Colors {
	...
	static function color_settings( $wp_customize ) {
		...
		$wp_customize->add_setting( 'mercia_theme_options[primary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[primary_color]', array(
				'label'    => esc_html_x( 'Primary', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[primary_color]',
				'priority' => 10,
			)
		) );

		// Add Secondary Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[secondary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[secondary_color]', array(
				'label'    => esc_html_x( 'Secondary', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[secondary_color]',
				'priority' => 20,
			)
		) );

		// Add Tertiary Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[tertiary_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[tertiary_color]', array(
				'label'    => esc_html_x( 'Tertiary', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[tertiary_color]',
				'priority' => 30,
			)
		) );

		// Add Accent Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[accent_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[accent_color]', array(
				'label'    => esc_html_x( 'Accent', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[accent_color]',
				'priority' => 40,
			)
		) );

		// Add Highlight Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[highlight_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[highlight_color]', array(
				'label'    => esc_html_x( 'Highlight', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[highlight_color]',
				'priority' => 50,
			)
		) );

		// Add Light Gray Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[light_gray_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[light_gray_color]', array(
				'label'    => esc_html_x( 'Light Gray', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[light_gray_color]',
				'priority' => 60,
			)
		) );

		// Add Gray Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[gray_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[gray_color]', array(
				'label'    => esc_html_x( 'Gray', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[gray_color]',
				'priority' => 70,
			)
		) );

		// Add Dark Gray Color setting.
		$wp_customize->add_setting( 'mercia_theme_options[dark_gray_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control(
			$wp_customize, 'mercia_theme_options[dark_gray_color]', array(
				'label'    => esc_html_x( 'Dark Gray', 'Color Option', 'mercia-pro' ),
				'section'  => 'mercia_pro_section_block_colors',
				'settings' => 'mercia_theme_options[dark_gray_color]',
				'priority' => 80,
			)
		) );
	}
...
// Run Class.
add_action( 'init', array( 'Mercia_Pro_Block_Colors', 'setup' ) );
add_filter( 'mercia_color_palette', array( 'Mercia_Pro_Block_Colors', 'block_color_palette' ) );

...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Mercia_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			// Set Fonts.
			$this->fonts = Mercia_Pro_Custom_Fonts::get_available_fonts();
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'mercia-pro-custom-font-control', MERCIA_PRO_PLUGIN_URL . 'assets/js/custom-font-control.min.js', array( 'customize-controls' ), '20210212', true );
		}

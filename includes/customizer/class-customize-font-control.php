...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Mercia_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'mercia-pro' ),
				'next'     => esc_html__( 'Next Font', 'mercia-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'mercia-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Mercia_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Mercia_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'mercia-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'mercia-pro' ); ?>">
	  							<?php
